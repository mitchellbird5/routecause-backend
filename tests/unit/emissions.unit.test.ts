...
import pool, { getTableColumns, getDistinctColumnValues } from "../../src/emissions/emissionsDatabase";

// Mock the database module
jest.mock("../../src/emissions/emissionsDatabase", () => {
  const actual = jest.requireActual("../../src/emissions/emissionsDatabase");
  return {
    __esModule: true,
    ...actual, // keep real functions like validateColumnAndFilter
    default: { query: jest.fn() }, // mock only pool.query
  };
});
